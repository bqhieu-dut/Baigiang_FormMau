...
% Bắt đầu 
%
% Change from English to Vietnamese
%
...
%\makeindex[intoc]
\makeindex[columns =2, title= Chỉ mục, intoc]
...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	Lưu hành nội bộ % Subtitle or further description
	...
	{\scshape\Large TS. Bùi Quang Hiếu} % Editor list
	
	\vspace{0.5\baselineskip} % Whitespace below the editor list
	
	\textit{Khoa Xây dựng Dân dụng và Công nghiệp \\ Trường Đại học Bách Khoa} % Editor affiliation
	...
	{\large Đại học Đà Nẵng} % Publisher
